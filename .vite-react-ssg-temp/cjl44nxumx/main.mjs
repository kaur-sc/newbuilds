...
function Navbar({ data }) {
  ...
  return /* @__PURE__ */ jsxs("nav", { className: "navbar", style: { backgroundColor: "var(--header-bg)" }, children: [
...
const routes = [
  {
    ...
    children: [
      ...
      {
        path: "style-editor/",
        element: /* @__PURE__ */ jsx(ThemeProvider, { children: /* @__PURE__ */ jsx(StyleEditor, {}) })
      },
      {
