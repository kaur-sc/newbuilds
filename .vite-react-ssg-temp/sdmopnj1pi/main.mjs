...
import { Globe, ChevronDown, X, Menu, ChevronRight, Check, ArrowRight, Maximize2, ChevronLeft, Sun, Waves, Bed, Bath, Ruler, Home, MapPin, Calendar, ShoppingBag, Coffee, Plane, Settings, RotateCcw, Settings2, Type, Download } from "lucide-react";
  ...
  return /* @__PURE__ */ jsxs("div", { className: "relative", ref: langRef, children: [
    /* @__PURE__ */ jsxs(
      "button",
      {
        ...
        className: "flex items-center gap-2 px-3 py-2 rounded-lg hover:bg-muted/50 transition-colors text-sm font-medium text-dark-blue",
        children: [
    ...
    isLangOpen && /* @__PURE__ */ jsx("div", { className: "absolute right-0 top-full mt-2 w-40 bg-white border border-gray-100 rounded-xl shadow-xl py-2 z-50 animate-fade-in", children: languages.map((lang) => /* @__PURE__ */ jsxs(
      "button",
      {
        onClick: () => {
        ...
        className: `w-full text-left px-4 py-2 text-sm hover:bg-muted/50 transition-colors flex items-center gap-3 ${i18n2.language === lang.code ? "font-bold text-primary" : "text-dark-blue"}`,
        children: [
...
const id$1 = "new-build-golf-properties-costa-blanca";
const name$1 = "Costa Blanca Golf Properties";
const brand$1 = { "colors": { "primary": "142.1 76.2% 36.3%", "secondary": "30 80% 90%" } };
const seo$3 = { "title": "Costa Blanca Golf Properties in Orihuela Costa | Modern New Builds", "description": "Modern new-build homes near five established golf courses on Spain’s sunny Costa Blanca South – designed for golfers, lifestyle buyers and long‑term investors.", "ogImage": "/assets/golf.jpg" };
const sections$1 = [{ "id": "announcement", "type": "banner", "enabled": true, "order": 0, "title": "EXCLUSIVE OFFER | COMPLIMENTARY GOLF MEMBERSHIP | LIMITED TIME" }, { "id": "hero", "type": "hero", "enabled": true, "order": 1, "title": "A Life Worth Gifting", "subtitle": "Discover the ultimate golf lifestyle on the Costa Blanca. Premium new build properties designed for refined living.", "media": "assets/golf.jpg", "layout": "left-aligned", "cta": { "label": "View Properties", "href": "#developments" } }, { "id": "developments", "type": "features", "enabled": true, "order": 2, "title": "Hand-picked Developments", "subtitle": "Selection of the most prestigious new build projects in Orihuela Costa.", "layout": "grid", "columns": 2 }, { "id": "lifestyle", "type": "features", "enabled": true, "order": 3, "title": "The Golf Lifestyle", "subtitle": "Live where you play. Experience world-class amenities and breathtaking views.", "media": "assets/golf.jpg", "layout": "split" }, { "id": "courses", "type": "features", "enabled": true, "order": 4, "title": "Premier Golf Courses", "subtitle": "Explore the five legendary courses surrounding your new home.", "layout": "grid", "columns": 3 }, { "id": "contact", "type": "contact", "enabled": true, "order": 5, "title": "Ready to Tee Off?", "content": "Schedule a private viewing or request our exclusive brochure today.", "cta": { "label": "Contact Our Experts", "href": "mailto:info@sunnycasas.com" } }];
...
const developmentsGrid = /* @__PURE__ */ Object.assign({ "../developments/new-build-golf-properties-costa-blanca.json": __vite_glob_0_0, "../developments/sunny-hills.json": __vite_glob_0_1 });
...
function Navbar({ data }) {
  ...
  return /* @__PURE__ */ jsxs("nav", { className: "navbar bg-white border-b border-gray-100 z-50 sticky top-0", children: [
    /* @__PURE__ */ jsxs(Container, { className: "navbar-container h-20 flex items-center justify-between", children: [
      /* @__PURE__ */ jsx(Link, { to: "/", className: "site-title text-dark-blue font-bold text-xl tracking-tight", children: "SUNNY CASAS" }),
      /* @__PURE__ */ jsxs("div", { className: "hidden md:flex items-center gap-8", children: [
        /* @__PURE__ */ jsxs("div", { className: "relative", ref: dropdownRef, children: [
          /* @__PURE__ */ jsxs(
            "button",
            {
              ...
              className: "nav-link flex items-center gap-1 group py-2",
              children: [
                "Golf Developments",
          ...
          isDropdownOpen && /* @__PURE__ */ jsx("div", { className: "absolute top-full left-0 mt-2 w-64 bg-white border border-gray-100 rounded-xl shadow-xl py-2 z-50 animate-fade-in", children: developments2.filter((dev) => dev.id !== "style-editor").map((dev) => /* @__PURE__ */ jsx(
            Link,
            {
              to: dev.id === "new-build-golf-properties-costa-blanca" ? "/" : `/developments/${dev.id}`,
              className: "block px-6 py-3 text-sm text-dark-blue hover:bg-muted/50 transition-colors",
        ...
        /* @__PURE__ */ jsx(Button, { asChild: true, className: "btn-primary rounded-full px-8", children: /* @__PURE__ */ jsx("a", { href: "#contact", children: "GET INFO" }) }),
    ...
    isOpen && /* @__PURE__ */ jsx("div", { className: "mobile-menu md:hidden fixed inset-x-0 top-20 bg-white border-b shadow-lg z-40 p-6 animate-fade-in", children: /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
      /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsx("p", { className: "text-xs font-bold text-gray-400 mb-4 tracking-widest uppercase", children: "Golf Developments" }),
        /* @__PURE__ */ jsx("div", { className: "grid gap-4", children: developments2.filter((dev) => dev.id !== "style-editor").map((dev) => /* @__PURE__ */ jsx(
          Link,
          {
            to: dev.id === "new-build-golf-properties-costa-blanca" ? "/" : `/developments/${dev.id}`,
            className: "text-lg text-dark-blue font-medium",
      ...
      /* @__PURE__ */ jsx("div", { className: "pt-4 border-t border-gray-100", children: /* @__PURE__ */ jsx(Button, { asChild: true, className: "btn-primary w-full h-14 text-lg rounded-full", children: /* @__PURE__ */ jsx("a", { href: "#contact", onClick: () => setIsOpen(false), children: "GET INFO" }) }) }),
  ...
  return /* @__PURE__ */ jsx("footer", { className: "bg-muted py-12", children: /* @__PURE__ */ jsxs(Container, { className: "flex flex-col md:flex-row justify-between items-center gap-6", children: [
    /* @__PURE__ */ jsxs("div", { children: [
      /* @__PURE__ */ jsx(
        ...
        {
          to: "/",
          className: "font-bold text-lg hover:text-primary transition-colors text-dark-blue",
          children: "SUNNY CASAS"
        }
      ),
...
function HeroSection({ data, namespace }) {
  ...
  return /* @__PURE__ */ jsxs(
    ...
    {
      id: data.id,
      className: `relative min-h-[85vh] flex items-center overflow-hidden ${isLeftAligned ? "bg-white" : "hero-parallax"}`,
      children: [
        /* @__PURE__ */ jsxs("div", { className: "absolute inset-0 z-0 pointer-events-none", children: [
          data.media && typeof data.media === "string" && /* @__PURE__ */ jsx(
            "img",
            {
          ...
          !isLeftAligned && /* @__PURE__ */ jsx("div", { className: "absolute inset-0 gradient-overlay z-10" })
        ] }),
        /* @__PURE__ */ jsx(Container, { className: "relative z-20 pointer-events-none", children: /* @__PURE__ */ jsxs("div", { className: `max-w-2xl pointer-events-auto animate-fade-in-up ${isLeftAligned ? "text-left lg:py-20" : "text-center mx-auto"}`, children: [
          /* @__PURE__ */ jsx("h1", { className: "h1 mb-6 text-dark-blue", children: t(`${data.id}.title`) }),
          t(`${data.id}.subtitle`) && /* @__PURE__ */ jsx("p", { className: "body-l mb-10 text-dark-blue opacity-85", children: t(`${data.id}.subtitle`) }),
          /* @__PURE__ */ jsxs("div", { className: `flex flex-wrap gap-4 ${isLeftAligned ? "justify-start" : "justify-center"}`, children: [
            data.cta ? /* @__PURE__ */ jsx(Button, { asChild: true, className: "btn-primary min-w-[200px]", children: /* @__PURE__ */ jsx("a", { href: data.cta.href, children: data.cta.label }) }) : /* @__PURE__ */ jsx(Button, { asChild: true, className: "btn-primary min-w-[200px]", children: /* @__PURE__ */ jsx("a", { href: "#contact", children: t(`${data.id}.cta_primary`, "Get Started") }) }),
            /* @__PURE__ */ jsx(Button, { asChild: true, className: "btn-secondary min-w-[200px]", children: /* @__PURE__ */ jsxs("a", { href: "#explore", className: "flex items-center gap-2", children: [
              t(`${data.id}.cta_explore`, "Explore"),
              " ",
...
function FeaturesSection({ data, namespace }) {
  const { t } = useTranslation(namespace);
  if (!data.enabled) return null;
  const layout = data.layout || "grid";
  const columns = data.columns || 3;
  const items = t(`${data.id}.items`, { returnObjects: true }) || data.items || [];
  if (layout === "split") {
    return /* @__PURE__ */ jsxs("section", { id: data.id, className: "split-layout", children: [
      /* @__PURE__ */ jsx("div", { className: "split-image relative overflow-hidden", children: /* @__PURE__ */ jsx(
        "img",
        {
          src: resolveAsset(data.media),
          alt: t(`${data.id}.title`),
      ...
      /* @__PURE__ */ jsx("div", { className: "split-content bg-dark-blue flex flex-col justify-center", children: /* @__PURE__ */ jsxs("div", { className: "max-w-xl animate-fade-in-up px-4 md:px-0", children: [
        /* @__PURE__ */ jsx("h2", { className: "h2 text-white mb-8", children: t(`${data.id}.title`) }),
        /* @__PURE__ */ jsx("div", { className: "space-y-6 mb-10", children: items.map((item, idx) => /* @__PURE__ */ jsxs("div", { className: "flex gap-4", children: [
          /* @__PURE__ */ jsx("div", { className: "mt-1", children: /* @__PURE__ */ jsx(Check, { className: "h-5 w-5 text-secondary" }) }),
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("h3", { className: "h3 text-white text-lg font-bold mb-1", children: item.title }),
            /* @__PURE__ */ jsx("p", { className: "body text-white/80", children: item.description })
          ] })
        ] }, idx)) }),
  ...
  return /* @__PURE__ */ jsx("section", { id: data.id, className: "modern-section bg-white", children: /* @__PURE__ */ jsxs(Container, { className: "container-modern", children: [
    /* @__PURE__ */ jsxs("div", { className: "text-left mb-16 animate-fade-in-up", children: [
      /* @__PURE__ */ jsx("h2", { className: "h2 text-dark-blue mb-4", children: t(`${data.id}.title`) }),
      t(`${data.id}.subtitle`) && /* @__PURE__ */ jsx("p", { className: "body-l text-dark-blue opacity-85 max-w-2xl", children: t(`${data.id}.subtitle`) })
    ] }),
    /* @__PURE__ */ jsx("div", { className: `grid gap-8 ${columns === 2 ? "md:grid-cols-2" : "md:grid-cols-3"}`, children: items.map((item, idx) => /* @__PURE__ */ jsxs(
      "div",
      {
        className: "group animate-fade-in-up",
        style: { animationDelay: `${idx * 100}ms` },
        children: [
          /* @__PURE__ */ jsx("div", { className: "aspect-[4/3] overflow-hidden rounded-lg mb-6 shadow-sm group-hover:shadow-md transition-shadow", children: /* @__PURE__ */ jsx(
            "img",
            {
          ...
          /* @__PURE__ */ jsx("h3", { className: "h3 text-dark-blue font-bold mb-2", children: item.title }),
          /* @__PURE__ */ jsx("p", { className: "body text-dark-blue opacity-85 mb-4", children: item.description }),
          item.cta && /* @__PURE__ */ jsx(Button, { asChild: true, className: "btn-secondary w-full", children: /* @__PURE__ */ jsx("a", { href: item.cta.href, children: item.cta.label }) })
        ]
      },
      idx
    )) })
...
function ContactSection({ data, namespace }) {
  const { t } = useTranslation(namespace);
  if (!data.enabled) return null;
  return /* @__PURE__ */ jsx("section", { id: data.id, className: "modern-section bg-dark-blue py-24", children: /* @__PURE__ */ jsx(Container, { className: "container-modern", children: /* @__PURE__ */ jsxs("div", { className: "max-w-4xl mx-auto text-center animate-fade-in-up", children: [
    /* @__PURE__ */ jsx("h2", { className: "h2 text-white mb-6", children: t(`${data.id}.title`, data.title) }),
    /* @__PURE__ */ jsx("p", { className: "body-l text-white/80 mb-12 max-w-2xl mx-auto", children: t(`${data.id}.description`, data.content) }),
    /* @__PURE__ */ jsxs("div", { className: "flex flex-col sm:flex-row gap-4 justify-center max-w-lg mx-auto", children: [
      /* @__PURE__ */ jsx(Button, { asChild: true, className: "btn-primary min-w-[240px]", children: /* @__PURE__ */ jsx("a", { href: data.cta?.href || "#contact", children: t(`${data.id}.cta`, data.cta?.label || "Get Started") }) }),
      /* @__PURE__ */ jsx(Button, { asChild: true, className: "btn-outline text-white border-white hover:bg-white/10 min-w-[240px]", children: /* @__PURE__ */ jsxs("a", { href: "tel:+34000000000", className: "flex items-center justify-center gap-2", children: [
        t(`${data.id}.call_us`, "Speak to an Expert"),
        " ",
        /* @__PURE__ */ jsx(ArrowRight, { className: "h-5 w-5" })
      ] }) })
    ] }),
    /* @__PURE__ */ jsxs("div", { className: "mt-16 pt-12 border-t border-white/10 flex flex-wrap justify-center gap-8 small text-white/60", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
        /* @__PURE__ */ jsx(Check, { className: "w-4 h-4 text-secondary" }),
        /* @__PURE__ */ jsx("span", { children: t(`${data.id}.trust_1`, "Free Information Pack") })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
        /* @__PURE__ */ jsx(Check, { className: "w-4 h-4 text-secondary" }),
        /* @__PURE__ */ jsx("span", { children: t(`${data.id}.trust_2`, "Direct Pricing") })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
        /* @__PURE__ */ jsx(Check, { className: "w-4 h-4 text-secondary" }),
        /* @__PURE__ */ jsx("span", { children: t(`${data.id}.trust_3`, "No Obligation") })
      ] })
    ] })
  ] }) }) });
}
function LandingPage({ data }) {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen flex flex-col font-sans text-foreground bg-background", children: [
    ...
    /* @__PURE__ */ jsx("main", { className: "flex-1", children: data.sections.sort((a, b) => a.order - b.order).map((section) => {
      ...
      switch (section.type) {
        case "hero":
          return /* @__PURE__ */ jsx(HeroSection, { data: section, namespace: data.id }, section.id);
        case "features":
          return /* @__PURE__ */ jsx(FeaturesSection, { data: section, namespace: data.id }, section.id);
        case "contact":
          return /* @__PURE__ */ jsx(ContactSection, { data: section, namespace: data.id }, section.id);
        case "banner":
          return /* @__PURE__ */ jsx("div", { className: "announcement-bar", children: t(`${section.id}.title`, section.title) }, section.id);
        default:
          return null;
      }
    }) }),
...
const themes = {
  ...
  cosmetic: {
    ...
    colors: {
      ...
      "--secondary": "#E5BB42",
      // Precise Yellow/Gold
      "--secondary-foreground": "#002459",
      "--accent": "#E5BB42",
      "--accent-foreground": "#002459",
      "--muted": "#C5CCD3",
      // Precise Gray-Blue
      "--muted-foreground": "#002459",
      "--background": "#ffffff",
      "--foreground": "#002459",
      "--card": "#ffffff",
      "--card-foreground": "#002459",
      "--popover": "#ffffff",
      "--popover-foreground": "#002459",
      "--border": "#E5E7EB",
      "--input": "#E5E7EB",
      "--ring": "#002459",
      "--radius": "0rem",
    ...
    baseTypo: {
      fontSize: "16px",
      fontFamily: '"roc-grotesk", ui-sans-serif, system-ui, sans-serif'
    },
    elementStyles: {
      h1: { size: "3.75rem", weight: "400", lineHeight: "1.2", letterSpacing: "-0.02em" },
      h2: { size: "2.5rem", weight: "400", lineHeight: "1.2", letterSpacing: "-0.01em" },
      h3: { size: "1.5rem", weight: "400", lineHeight: "1.4", letterSpacing: "0" },
      body: { size: "1rem", weight: "300", lineHeight: "1.6", letterSpacing: "0" },
      "body-l": { size: "1.25rem", weight: "300", lineHeight: "1.5", letterSpacing: "0" },
      small: { size: "0.875rem", weight: "300", lineHeight: "1.4", letterSpacing: "0.01em" },
      caption: { size: "0.75rem", weight: "300", lineHeight: "1.3", letterSpacing: "0.02em" },
      "btn-primary": { bg: "var(--secondary)", text: "var(--secondary-foreground)", radius: "35px", px: "2rem", py: "0.75rem", weight: "400" },
      "btn-secondary": { bg: "var(--muted)", text: "var(--primary)", radius: "35px", px: "2rem", py: "0.75rem", weight: "400" },
      "btn-outline": { bg: "transparent", text: "var(--primary)", radius: "35px", px: "2rem", py: "0.75rem", border: "var(--primary)", weight: "400" },
      "btn-ghost": { bg: "transparent", text: "var(--primary)", radius: "35px", px: "2rem", py: "0.75rem", weight: "400" },
      "link-std": { text: "var(--primary)", weight: "400", under: "underline" },
      "link-bold": { text: "var(--primary)", weight: "500", under: "none" },
      "site-title": { size: "1.5rem", weight: "500", lineHeight: "1.2", letterSpacing: "0.05em" },
      "mobile-menu-btn": { size: "1rem", weight: "400", lineHeight: "1.4", letterSpacing: "0.01em" },
      "mobile-menu-links": { size: "1.25rem", weight: "400", lineHeight: "1.5", letterSpacing: "0.01em" },
      "gallery-tab-container": {
        bg: "var(--muted)",
        px: "0.5rem",
        py: "0.5rem",
...
const RootLayout = () => {
  return /* @__PURE__ */ jsx(Suspense, { fallback: /* @__PURE__ */ jsx("div", { className: "flex items-center justify-center min-h-screen", children: "Loading..." }), children: /* @__PURE__ */ jsx(ThemeProvider, { children: /* @__PURE__ */ jsx(Outlet, {}) }) });
};
const routes = [
  {
    path: "/",
    ...
    children: [
      {
        index: true,
        element: /* @__PURE__ */ jsx(LandingPage, { data: getDevelopment("new-build-golf-properties-costa-blanca") })
        // Default/Home
      },
      {
...
const announcement$1 = { "title": "EXCLUSIVE OFFER | COMPLIMENTARY GOLF MEMBERSHIP | LIMITED TIME" };
const hero$1 = { "title": "A Life Worth Gifting", "subtitle": "Discover the ultimate golf lifestyle on the Costa Blanca. Premium new build properties designed for refined living.", "cta": { "label": "View Properties" }, "explore": "Explore Communities" };
const developments$1 = { "title": "Hand-picked Developments", "subtitle": "Selection of the most prestigious new build projects in Orihuela Costa.", "items": [{ "title": "Vistabella Golf Homes", "description": "Contemporary villas and apartments integrated into the lush landscape of Vistabella Golf.", "image": "assets/golf.jpg", "cta": { "label": "View Project", "href": "/developments/vistabella" } }, { "title": "Las Colinas Residences", "description": "Award-winning luxury residences within a private valley, offering extreme privacy and world-class golf.", "image": "assets/golf.jpg", "cta": { "label": "View Project", "href": "/developments/las-colinas" } }] };
const lifestyle$1 = { "title": "The Golf Lifestyle", "subtitle": "Live where you play. Experience world-class amenities and breathtaking views.", "items": [{ "title": "Year-Round Playing", "description": "With over 300 days of sunshine, enjoy your passion every single day of the year." }, { "title": "Luxury Amenities", "description": "Access to exclusive clubhouses, spa facilities, and fine dining at your doorstep." }, { "title": "Investment Value", "description": "Golf properties on the Costa Blanca maintain high demand and excellent capital appreciation." }] };
const courses$1 = { "title": "Premier Golf Courses", "subtitle": "Explore the five legendary courses surrounding your new home.", "items": [{ "title": "Las Colinas Golf", "description": "Cabell B. Robinson designed championship course in a natural valley.", "image": "assets/golf.jpg" }, { "title": "Villamartin Golf", "description": "One of the most established and iconic courses on the coast.", "image": "assets/golf.jpg" }, { "title": "Las Ramblas Golf", "description": "A challenging course with dramatic landscapes and Mediterranean views.", "image": "assets/golf.jpg" }] };
const contact$1 = { "title": "Ready to Tee Off?", "description": "Schedule a private viewing or request our exclusive brochure today.", "cta": { "label": "Contact Our Experts" } };
...
const hero = { "title": "Une vie digne d'être offerte", "subtitle": "Découvrez le style de vie golfique ultime sur la Costa Blanca. Des propriétés neuves haut de gamme conçues pour une vie raffinée.", "cta": { "label": "Voir les Propriétés" }, "explore": "Explorer les Communautés" };
