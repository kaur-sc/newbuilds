...
function Navbar({ data }) {
  ...
  return /* @__PURE__ */ jsxs("nav", { className: "navbar", style: {
        ...
        /* @__PURE__ */ jsxs("div", { className: "p-8 space-y-8 max-h-[60vh] overflow-y-auto", children: [
          ...
          editingStyle === "navbar" && /* @__PURE__ */ jsxs("div", { className: "space-y-6 pt-6 border-t border-slate-100", children: [
            ...
            /* @__PURE__ */ jsx("div", { className: "space-y-4", children: /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 gap-4", children: [
              activeTheme?.elementStyles?.[editingStyle]?.bg && /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
                /* @__PURE__ */ jsx("label", { className: "text-[10px] font-bold text-slate-400", children: "Background Color" }),
                /* @__PURE__ */ jsx("input", { type: "color", value: activeTheme.elementStyles[editingStyle].bg || "#ffffff", onChange: (e) => handleElementStyleChange(editingStyle, "bg", e.target.value), className: "w-full bg-slate-50 border border-slate-200 rounded-lg p-2 text-sm" })
              ] }),
              activeTheme?.elementStyles?.[editingStyle]?.transparency !== void 0 && /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
                /* @__PURE__ */ jsxs("label", { className: "text-[10px] font-bold text-slate-400", children: [
                  "Transparency: ",
                  activeTheme.elementStyles[editingStyle].transparency
                ] }),
                /* @__PURE__ */ jsx("input", { type: "range", min: "0", max: "1", step: "0.1", value: activeTheme.elementStyles[editingStyle].transparency || "0.3", onChange: (e) => handleElementStyleChange(editingStyle, "transparency", e.target.value), className: "w-full bg-slate-50 border border-slate-200 rounded-lg p-2 text-sm" })
              ] }),
              activeTheme?.elementStyles?.[editingStyle]?.blur !== void 0 && /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
                /* @__PURE__ */ jsxs("label", { className: "text-[10px] font-bold text-slate-400", children: [
                  "Blur: ",
                  activeTheme.elementStyles[editingStyle].blur
                ] }),
                /* @__PURE__ */ jsx("input", { type: "range", min: "0", max: "20", step: "1", value: activeTheme.elementStyles[editingStyle].blur || "8", onChange: (e) => handleElementStyleChange(editingStyle, "blur", e.target.value), className: "w-full bg-slate-50 border border-slate-200 rounded-lg p-2 text-sm" })
              ] }),
              activeTheme?.elementStyles?.[editingStyle]?.border && /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
                /* @__PURE__ */ jsx("label", { className: "text-[10px] font-bold text-slate-400", children: "Border Color" }),
                /* @__PURE__ */ jsx("input", { type: "color", value: activeTheme.elementStyles[editingStyle].border || "#e5e7eb", onChange: (e) => handleElementStyleChange(editingStyle, "border", e.target.value), className: "w-full bg-slate-50 border border-slate-200 rounded-lg p-2 text-sm" })
              ] })
            ] }) })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "space-y-6 pt-6 border-t border-slate-100", children: [
