          ...
          /* @__PURE__ */ jsxs("div", { className: "space-y-6 pt-6 border-t border-slate-100", children: [
            ...
            /* @__PURE__ */ jsx("div", { className: "space-y-4", children: /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 gap-4", children: [
              /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
                ...
                /* @__PURE__ */ jsx("input", { type: "color", defaultValue: "#ffffff", className: "w-full bg-slate-50 border border-slate-200 rounded-lg p-2 text-sm" })
              ] }),
              /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
                /* @__PURE__ */ jsx("label", { className: "text-[10px] font-bold text-slate-400", children: "Transparency" }),
                /* @__PURE__ */ jsx("input", { type: "range", min: "0", max: "1", step: "0.1", defaultValue: "0.3", className: "w-full bg-slate-50 border border-slate-200 rounded-lg p-2 text-sm" })
              ] }),
              /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
                /* @__PURE__ */ jsx("label", { className: "text-[10px] font-bold text-slate-400", children: "Blur" }),
                /* @__PURE__ */ jsx("input", { type: "range", min: "0", max: "20", step: "1", defaultValue: "8", className: "w-full bg-slate-50 border border-slate-200 rounded-lg p-2 text-sm" })
              ] }),
              /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
                /* @__PURE__ */ jsx("label", { className: "text-[10px] font-bold text-slate-400", children: "Border Color" }),
                /* @__PURE__ */ jsx("input", { type: "color", defaultValue: "#e5e7eb", className: "w-full bg-slate-50 border border-slate-200 rounded-lg p-2 text-sm" })
              ] })
            ] }) })
          ] })
        ] }),
